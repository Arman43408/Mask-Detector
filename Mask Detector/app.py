...
model = load_model(f"D:\Spring 2022-23/CVPR/Final/Assignment-1/mymodel.h5",compile=False)

with open(f'D:\Spring 2022-23/CVPR/Final/Assignment-1/category2label.pkl', 'rb') as cat:
...
face_cascade = cv2.CascadeClassifier(f'D:\Spring 2022-23/CVPR/Final/Assignment-1/haarcascade_frontalface_default.xml')
